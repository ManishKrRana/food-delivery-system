					...
					linear: {
						toValue: function (t) {
							...
							if (this.options.ticks_positions.length > 0) {
								for (var s, n, o, a = 0, r = 1; r < this.options.ticks_positions.length; r++)
				...
				(s.prototype = {
					...
					setValue: function (t, e, i) {
						...
						return (
							...
							s !== o && i === !0 && this._trigger("change", { oldValue: s, newValue: o }),
							this
						);
					},
					destroy: function () {
					...
					_removeSliderEventHandlers: function () {
						if (
							...
							for (
								var t = this.ticksContainer.getElementsByClassName("slider-tick"), e = 0;
								e < t.length;
								e++
							)
								t[e].removeEventListener("mouseenter", this.ticksCallbackMap[e].mouseEnter, !1),
					...
					_layout: function () {
						...
						if (
							...
							for (var e = 0; e < this.options.rangeHighlights.length; e++) {
								...
								o
									? "vertical" === this.options.orientation
										? ((this.rangeHighlightElements[e].style.top = o.start + "%"),
										  (this.rangeHighlightElements[e].style.height = o.size + "%"))
										: ((this.rangeHighlightElements[e].style.left = o.start + "%"),
										  (this.rangeHighlightElements[e].style.width = o.size + "%"))
					...
					_keydown: function (t, e) {
						...
						if (i) {
							...
							return (
								this.options.range &&
									(o = [t ? this._state.value[0] : o, t ? o : this._state.value[1]]),
					...
					_touchmove: function (t) {
						if (void 0 !== t.changedTouches) {
							...
							this._state.inDrag ||
								...
								(s >= 15 || -15 >= s)
									? this._mousedown(t)
									: 5 >= s && s >= -5 && (i >= 15 || -15 >= i) && this._mousedown(t));
						}
					},
						...
						if (this.options.range) {
							...
							this._applyToFixedAndParseFloat(this._state.percentage[1], e) < i
								...
								: 1 === this._state.dragged &&
								  this._applyToFixedAndParseFloat(this._state.percentage[0], e) > i &&
					...
					_getPercentage: function (t) {
						...
						return (
							(n = Math.round(n / this._state.percentage[2]) * this._state.percentage[2]),
