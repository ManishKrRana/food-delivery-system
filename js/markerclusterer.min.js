...
(MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_PATH_ =
	...
	(MarkerClusterer.prototype.fitMapToMarkers = function () {
		for (var s, t = this.getMarkers(), e = new google.maps.LatLngBounds(), i = 0; (s = t[i]); i++)
	...
	(Cluster.prototype.getBounds = function () {
		for (
			var s, t = new google.maps.LatLngBounds(this.center_, this.center_), e = this.getMarkers(), i = 0;
			(s = e[i]);
			i++
		)
	...
	(Cluster.prototype.updateIcon = function () {
		...
		if (e && t > e) for (var s, i = 0; (s = this.markers_[i]); i++) s.setMap(this.map_);
		else {
