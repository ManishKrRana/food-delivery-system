				...
				var h = !1,
					...
					k = {
						...
						getSelectorFromElement: function (a) {
							...
							return (
								b || ((b = a.getAttribute("href") || ""), (b = /^#[a-z]/i.test(b) ? b : null)),
								b
							);
						},
						reflow: function (a) {
							...
							return (
								...
								(j.prototype._activate = function (b) {
									...
									d.hasClass(o.DROPDOWN_ITEM)
										? (d.closest(p.DROPDOWN).find(p.DROPDOWN_TOGGLE).addClass(o.ACTIVE),
										  d.addClass(o.ACTIVE))
										: d.parents(p.LI).find(p.NAV_LINKS).addClass(o.ACTIVE),
										a(this._scrollElement).trigger(n.ACTIVATE, { relatedTarget: b });
								}),
							...
							return (
								...
								(j.prototype._enter = function (b, c) {
									...
									return (
										...
										b &&
											(c._activeTrigger["focusin" === b.type ? u.FOCUS : u.HOVER] =
												!0),
								...
								(j.prototype._leave = function (b, c) {
									...
									if (
										...
										c ||
											...
											a(b.currentTarget).data(d, c)),
										b &&
											(c._activeTrigger["focusout" === b.type ? u.FOCUS : u.HOVER] =
												!1),
						...
						(l._jQueryInterface = function (a) {
							return this.each(function () {
								...
								if (
									...
									(b || ((b = new l(this, c)), f(this).data(j, b)), "string" == typeof a)
								) {
