!(function (t) {
					...
					this._on(this.element, {
						...
						blur: function (t) {
							return this.cancelBlur
								...
								: (clearTimeout(this.searching), this.close(t), void this._change(t));
						},
					}),
					this._initSource(),
					(this.menu = t("<ul>")
	...
	t.extend(s.prototype, {
			...
			if ((0 > J && ((J += 12), tt--), Z))
				for (
					e = this._daylightSavingAdjust(
						new Date(Z.getFullYear(), Z.getMonth() - U[0] * U[1] + 1, Z.getDate())
					),
						e = Q && Q > e ? Q : e;
				...
				for (k = "", this.maxRows = 4, C = 0; U[1] > C; C++) {
					...
					for (
						T +=
							...
							this._generateMonthYearHeader(t, J, tt, Q, Z, x > 0 || C > 0, f, g) +
						...
						for (
							...
							(W = m ? m.apply(t.input ? t.input[0] : null, [A]) : [!0, ""]),
								...
								(N +=
									...
									((A.getTime() === D.getTime() && J === t.selectedMonth && t._keyEvent) ||
		...
		_generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
			...
			return (
				(b += this._get(t, "yearSuffix")), v && (b += (!o && m && _ ? "" : "&#xa0;") + y), (b += "</div>")
			);
		},
				...
				return (
					this._helper &&
						...
						(r =
							...
							null),
						(l =
							parseFloat(c.element.css("top")) + (c.position.top - c.originalPosition.top) ||
							null),
	...
	(t.ui.ddmanager = {
		...
		t.widget("ui.progressbar", {
			...
			value: function (t) {
				return void 0 === t
					? this.options.value
					: ((this.options.value = this._constrainedValue(t)), void this._refreshValue());
			},
			...
			_events: {
				...
				"mouseenter .ui-spinner-button": function (e) {
					return t(e.currentTarget).hasClass("ui-state-active")
						? this._start(e) === !1
							? !1
							: void this._repeat(null, t(e.currentTarget).hasClass("ui-spinner-up") ? 1 : -1, e)
						: void 0;
				},
